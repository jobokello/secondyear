...
<body>
    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            <div class="row">
                <div class="col-lg-12">
                  <h1 class="page-header">  <span class="fa fa-edit"></span>Create new Post</h1>
                </div>
                <!-- /.col-lg-12 -->
            </div>
            <!-- /.row -->
			 ...
			 <div class="col-lg-6">
                <form role="form" action="" method="POST" enctype="multipart/form-data">
                                        <div class="form-group">
                                            ...
                                            <p class="help-block">Give Title of the post.</p>
                                        </div>
                                  
                                        <div class="form-group">
                                            <label>Image </label>
                                            <p class="form-control-static">upload image size 50kb</p>
                                        </div>
                                        <div class="form-group">
